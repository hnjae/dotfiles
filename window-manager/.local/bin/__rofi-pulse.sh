...
# copied from: https://blog.codeaddict.org/2020/04/26/using-rofi-to-switch-pulseaudio-default-sink/source/
...
echo "$list" \
	...
	# | rofi -dmenu -p "pulseaudio $type:" -selected-row $default_row -dpi $DPI \
