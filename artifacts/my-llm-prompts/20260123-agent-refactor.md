...
- You have full authority to make breaking changes (internal or user-facing)
- Prefer established libraries over custom code when they improve quality
- Verify behavior through code inspection; don't assume documentation is accurate
